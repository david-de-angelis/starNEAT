...
class GreedyPlayoutsPlayer(Player):
    ...
    def __init__(self, color, num_playouts=DEFAULT_NUM_PLAYOUTS):
        ...
        self.USE_MULTIPROCESSING = bool(multiprocessing.current_process().name == "MainProcess")
    ...
    def decide(self, game: Game, playable_actions):
        ...
        for action in playable_actions:
            ...
            counter = run_playouts(action_applied_game_copy, num_playouts, self.USE_MULTIPROCESSING)
...
def run_playouts(action_applied_game_copy, num_playouts, USE_MULTIPROCESSING):
    start = time.time()
    params = []
